...
<body>
    ...
    <div id="video-container">
        ...
        <div class="video-content">
            <div class="inner">
              <h1>Welcome to <em>Plotti Botti</em></h1>
              <p>This is a photo gallery for Plotti Botti</p>
              <p>Contribute and vote for the images you like</p>
    ...
    <div id="modal" class="modal">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h3 class="header-title">Say hello to <em>Plotti Botti!</em></h3>
      ...
      <div class="container">
        <div class="row">
          <div class="main-menu">
              <ul>
                  <li>
                      <a href="index.blade.php">Home - Full-width</a>
                  </li>
                  <li>
                      <a href="masonry.blade.php">Home - Masonry</a>
                  </li>
                  <li>
                      <a href="grid.blade.php">Home - Small-width</a>
                  </li>
                  <li>
                      <a href="about.blade.php">About Us</a>
                  </li>
                  <li>
                      <a href="blog.blade.php">Blog Entries</a>
                  </li>
                  <li>
                      <a href="single-post.blade.php">Single Post</a>
                  </li>
              </ul>
